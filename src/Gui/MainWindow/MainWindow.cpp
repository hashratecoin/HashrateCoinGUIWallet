...
const char COMMUNITY_FORUM_URL[] = "https://t.me/hashratecoin";
const char REPORT_ISSUE_URL[] = "http://hashratecoin.org/";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("hashratecoin Wallet 1.0").arg(Settings::instance().getVersion()));
